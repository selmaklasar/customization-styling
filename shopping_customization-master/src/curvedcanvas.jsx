...
setDownloadtype(event.target.value)
  ...
  return (
    <div className={style.curved_app}>
      ...
      <canvas ref={canvasRef} width="400" height="300" style={{ border: '1px solid black' }}   className={style.canvas_background}> </canvas>
      <br />
  ...
  <div className={style.text_field}>
      ...
      <input type="text" value={text} onChange={handleInputChange} placeholder="Enter text" className={style.inputfield}/>
      <div className={style.curve}>
        <p>Adjust the curve</p>
      <input type='number' onChange={(e) => { setCurve(e.target.value) }} /> 
      <h3 className={style.header_font}>Choose font:</h3>
      <select value={selectedFont} onChange={handleFontChange} className={style.fontselection}>
     ...
     <div className={style.download_option}>
     <button onClick={handleDownload} className={style.imgdwnload_btn}>Download Image</button>
     <div className={style.imageformat}>
